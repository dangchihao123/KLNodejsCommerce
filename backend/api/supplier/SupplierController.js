const { create, getSupplier, getSupplierBySupplierId, updateSupplier, deleteSupplier } = require('./supplier.service');
...
module.exports = {
    ...
    getSupplierBySupplierId: (req, res)=> {
        ...
        getSupplierBySupplierId(id, (err, results)=>{
            if(err){
                console.log(err)
                return
            }
    ...
    deleteSupplier: (req, res)=>{
        ...
        deleteSupplier(data, (err, result)=>{
            if(err){
                console.log(err)
                return
            }
